...
#
# Generated by export_simulation on Sun Jul 31 08:51:35 +0700 2022
#
################################################################################
...
'-reset_run' switch to the './viter.sh' script.
...
./viter.sh -noclean_files

For more information on the script, please type './viter.sh -help'.
