...
# module references:
# compare_1, compare_2, compare_3, compare_4, control, splitstring, state00, state01, state10, state11, traceback
...
proc create_root_design { parentCell } {
  ...
  # Create instance: compare_4, and set properties
  set block_name compare_4
  set block_cell_name compare_4
  if { [catch {set compare_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $compare_4 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins compare_1/clk] [get_bd_pins compare_2/clk] [get_bd_pins compare_3/clk] [get_bd_pins compare_4/clk] [get_bd_pins control/clk] [get_bd_pins splitstring/clk]
  ...
  connect_bd_net -net compare_3_0_differsum3 [get_bd_pins compare_2/differsum3] [get_bd_pins compare_3/differsum3] [get_bd_pins compare_4/differsum3] [get_bd_pins traceback/differsum3]
  ...
  connect_bd_net -net compare_4_0_differsum4 [get_bd_pins compare_2/differsum4] [get_bd_pins compare_4/differsum4] [get_bd_pins traceback/differsum4]
  connect_bd_net -net compare_4_0_mem_reg_4 [get_bd_pins compare_4/mem_reg_4] [get_bd_pins traceback/mem_reg_4]
  connect_bd_net -net compare_4_0_pre_state_4 [get_bd_pins compare_4/pre_state_4] [get_bd_pins traceback/pre_state4]
  connect_bd_net -net control_0_flag [get_bd_pins compare_1/flag] [get_bd_pins compare_2/flag] [get_bd_pins compare_3/flag] [get_bd_pins compare_4/flag] [get_bd_pins control/flag] [get_bd_pins splitstring/flag] [get_bd_pins traceback/flag]
  connect_bd_net -net data_in_0_1 [get_bd_ports data_in] [get_bd_pins splitstring/data_in]
  connect_bd_net -net en_0_1 [get_bd_ports en] [get_bd_pins compare_1/en] [get_bd_pins compare_2/en] [get_bd_pins compare_3/en] [get_bd_pins compare_4/en] [get_bd_pins splitstring/en] [get_bd_pins state00/en] [get_bd_pins state01/en] [get_bd_pins state10/en] [get_bd_pins state11/en]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins splitstring/rst] [get_bd_pins state00/rst] [get_bd_pins state01/rst] [get_bd_pins state10/rst] [get_bd_pins state11/rst]
  connect_bd_net -net splitstring_0_bit_in [get_bd_pins compare_1/bit_in] [get_bd_pins compare_2/bit_in] [get_bd_pins compare_3/bit_in] [get_bd_pins compare_4/bit_in] [get_bd_pins splitstring/bit_in]
  connect_bd_net -net state00_0_bit_out_1 [get_bd_pins compare_1/bit_out_1] [get_bd_pins state00/bit_out_1]
  connect_bd_net -net state00_0_bit_out_2 [get_bd_pins compare_3/bit_out_2] [get_bd_pins state00/bit_out_2]
  ...
  connect_bd_net -net state01_0_bit_out_3 [get_bd_pins compare_1/bit_out_3] [get_bd_pins state01/bit_out_3]
  connect_bd_net -net state01_0_bit_out_4 [get_bd_pins compare_3/bit_out_4] [get_bd_pins state01/bit_out_4]
  ...
  connect_bd_net -net state10_0_bit_out_5 [get_bd_pins compare_2/bit_out_5] [get_bd_pins state10/bit_out_5]
  connect_bd_net -net state10_0_bit_out_6 [get_bd_pins compare_4/bit_out_6] [get_bd_pins state10/bit_out_6]
  connect_bd_net -net state10_0_reg_out5 [get_bd_pins compare_2/reg_out5] [get_bd_pins state10/reg_out5]
  connect_bd_net -net state10_0_reg_out6 [get_bd_pins compare_4/reg_out6] [get_bd_pins state10/reg_out6]
  connect_bd_net -net state11_0_bit_out_7 [get_bd_pins compare_2/bit_out_7] [get_bd_pins state11/bit_out_7]
  connect_bd_net -net state11_0_reg_out7 [get_bd_pins compare_2/reg_out7] [get_bd_pins state11/reg_out7]
  connect_bd_net -net state11_bit_out_8 [get_bd_pins compare_4/bit_out_8] [get_bd_pins state11/bit_out_8]
  connect_bd_net -net state11_reg_out8 [get_bd_pins compare_4/reg_out8] [get_bd_pins state11/reg_out8]
