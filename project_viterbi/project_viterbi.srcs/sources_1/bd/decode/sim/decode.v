...
//Command     : generate_target decode.bd
//Design      : decode
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "decode,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=decode,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=15,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "decode.hwdef" *) 
module decode
   (clk,
    data_in,
    done,
    ...
    mem_out,
    rst);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET rst, CLK_DOMAIN decode_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  input [15:0]data_in;
  output done;
  input en;
  output [7:0]mem_out;
  ...
  assign rst_0_1 = rst;
  decode_compare_1_0_0 compare_1
       (.clk(clk_0_1),
        ...
        .rst(rst_0_1));
  decode_compare_2_0_0 compare_2
       (.clk(clk_0_1),
        ...
        .rst(rst_0_1));
  decode_compare_3_0_0 compare_3
       (.clk(clk_0_1),
        ...
        .rst(rst_0_1));
  decode_comparer_4_0_0 comparer_4
       (.clk(clk_0_1),
        ...
        .rst(rst_0_1));
  decode_control_0_0 control
       (.clk(clk_0_1),
        .en(en_0_1),
        .flag(control_0_flag),
        .rst(rst_0_1));
  decode_detect1_0_0 detect1
  ...
  decode_detect4_0_0 detect4
       (.bit_in(splitstring_0_bit_in),
        ...
        .flag(control_0_flag),
        .rst(rst_0_1));
  decode_splitstring_0_0 splitstring
       (.bit_in(splitstring_0_bit_in),
        .clk(clk_0_1),
        .data_in(data_in_0_1),
        .en(en_0_1),
  ...
  decode_state11_0_0 state11
       (.bit_out_7(state11_0_bit_out_7),
        ...
        .reg_out8(state11_0_reg_out8),
        .rst(rst_0_1));
  decode_traceback_0_0 traceback
       (.clk(clk_0_1),
        .differsum1(compare_1_0_differsum1),
        .differsum2(compare_2_0_differsum2),
        .differsum3(compare_3_0_differsum3),
